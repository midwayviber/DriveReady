...
- [x] 8. **[Find the Missing Number](https://leetcode.com/problems/missing-number/)** (Easy)  
- [x] 9. **[Merge Two Sorted Arrays](https://leetcode.com/problems/merge-sorted-array/)** (Easy)  
...
- [x] 13. **[Find Majority Element](https://leetcode.com/problems/majority-element/)** (Easy)  
- [x] 14. **[Find All Duplicates in an Array](https://leetcode.com/problems/find-all-duplicates-in-an-array/)** (Medium)  
...
- [x] 2. **[Sort Colors (0s, 1s, 2s)](https://leetcode.com/problems/sort-colors/)** (Medium)  
...
- [x] 5. **[Find Kth Largest Element](https://leetcode.com/problems/kth-largest-element-in-an-array/)** (Medium)  
...
- [x] 16. **[Find K Closest Elements](https://leetcode.com/problems/find-k-closest-elements/)** (Medium)  
