...
- [x] 3. **[Find Second Largest Element](https://www.geeksforgeeks.org/second-largest-element-array/)** (Easy)  
- [x] 4. **[Check if Array is Sorted](https://leetcode.com/problems/check-if-array-is-sorted-and-rotated/)** (Medium)  
- [x] 5. **[Remove Duplicates from Sorted Array](https://leetcode.com/problems/remove-duplicates-from-sorted-array/)** (Easy)  
- [x] 6. **[Move Zeroes to End](https://leetcode.com/problems/move-zeroes/)** (Easy)  
- [x] 7. **[Rotate Array by K Positions](https://leetcode.com/problems/rotate-array/)** (Medium)  
...
- [x] 10. **[Find the Intersection of Two Arrays](https://leetcode.com/problems/intersection-of-two-arrays/)** (Easy)  
- [x] 11. **[Find the Union of Two Arrays](https://www.geeksforgeeks.org/find-union-and-intersection-of-two-unsorted-arrays/)** (Medium)  
- [x] 12. **[Find Leaders in an Array](https://www.geeksforgeeks.org/leaders-in-an-array/)** (Medium)  
...
- [x] 6. **[Next Permutation](https://leetcode.com/problems/next-permutation/)** (Medium)  
...
- [x] 10. **[Binary Search in Rotated Sorted Array](https://leetcode.com/problems/search-in-rotated-sorted-array/)** (Medium)  
- [ ] 11. **[Median of Two Sorted Arrays](https://leetcode.com/problems/median-of-two-sorted-arrays/)** (Hard)  
- [x] 12. **[Sort Characters By Frequency](https://leetcode.com/problems/sort-characters-by-frequency/)** (Medium)  
